...
const Reviews = (props: Props) => {
  ...
  return (
    <div className="w-[70%] 800px:w-[85%] m-auto relative">
      <div className="w-full 800px:flex items-center">
        <div className="800px:w-[50%] w-full">
          <Image
            src={require("../../../public/assests/business-img.png")}
      ...
      <br />
<div className="border 20px p-[2%] flex flex-col justify-center items-center ">
...
<div className=" w-[70%] ">
    ...
    <div className=" flex justify-between mt-[5%] mb-[3%] w-[70%] ">
        <button className="bg-gray-500 text-white px-4 py-2 rounded-full" onClick={goToPrev}>
          Prev
        </button>
        <button className="bg-gray-500 text-white px-4 py-2 rounded-full" onClick={goToNext}>
          Next
        </button>
      </div>
    </div>
